...
It's is also meant as a fun way for me to express myself as demonstrated by it's pixel style and background graphics.

It is built entirely with vanilla HTML + CS + JS. The animated fish background and the little walking guys are both inside an HTML canvas element where all the logic is coded in JS.
